...
${TESTDIR}/ut/ut_arch/cwsw_arch_test.o: ut/ut_arch/cwsw_arch_test.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/ut/ut_arch/cwsw_arch_test.o ut/ut_arch/cwsw_arch_test.c


${TESTDIR}/ut/ut_lib/cwsw_lib_test.o: ut/ut_lib/cwsw_lib_test.c 
	${MKDIR} -p ${TESTDIR}/ut/ut_lib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/ut/ut_lib/cwsw_lib_test.o ut/ut_lib/cwsw_lib_test.c
...
${OBJECTDIR}/cwsw_arch/i386/peripheral/ports/ports_api_nomain.o: ${OBJECTDIR}/cwsw_arch/i386/peripheral/ports/ports_api.o cwsw_arch/i386/peripheral/ports/ports_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cwsw_arch/i386/peripheral/ports/ports_api_nomain.o cwsw_arch/i386/peripheral/ports/ports_api.c;\
	else  \
...
${OBJECTDIR}/cwsw_board/none/src/cwsw_board_nomain.o: ${OBJECTDIR}/cwsw_board/none/src/cwsw_board.o cwsw_board/none/src/cwsw_board.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cwsw_board/none/src/cwsw_board_nomain.o cwsw_board/none/src/cwsw_board.c;\
	else  \
