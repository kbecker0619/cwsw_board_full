...
${OBJECTDIR}/ut/ut_arch/cwsw_arch_test.o: ut/ut_arch/cwsw_arch_test.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DXPRJ_NB_${CONF} -Icfg -Icwsw_lib -Icwsw_arch/i386 -Icwsw_board/none -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ut/ut_arch/cwsw_arch_test.o ut/ut_arch/cwsw_arch_test.c

${OBJECTDIR}/ut/ut_lib/cwsw_lib_test.o: ut/ut_lib/cwsw_lib_test.c
	${MKDIR} -p ${OBJECTDIR}/ut/ut_lib
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DXPRJ_NB_${CONF} -Icfg -Icwsw_lib -Icwsw_arch/i386 -Icwsw_board/none -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ut/ut_lib/cwsw_lib_test.o ut/ut_lib/cwsw_lib_test.c
